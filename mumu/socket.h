 ...
 * @date 2019-06-05
 * @copyright Copyright (c) 2019年 muhui.yin All rights reserved (www.sylar.top)
 */
#ifndef __MUHUI_SOCKET_H__
#define __MUHUI_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(muhui::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(muhui::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(muhui::Address::ptr address);
